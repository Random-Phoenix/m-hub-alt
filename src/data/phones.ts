...
export const phones: Phone[] = [
  ...
  ...Array.from({ length: 50 }, (_, i) => ({
    ...
    name: [
      ...
      "Asus ROG Phone 8",
      "Sony Xperia 10 VI",
      "ZTE Nubia Red Magic 10",
      "Meizu 20 Pro",
      "Black Shark 7 Pro",
      "Lenovo Legion Phone 4",
      "Poco F6 Pro",
    ][i],
    price: parseInt(
      [
  ...
  ...Array.from({ length: 50 }, (_, i) => ({
    ...
    name: [
      ...
      "Asus ROG Phone 9",
      "Sony Xperia 11 VI",
      "ZTE Nubia Red Magic 11",
      "Meizu 21 Pro",
      "Black Shark 8 Pro",
      "Lenovo Legion Phone 5",
      "Poco F7 Pro",
    ][i],
    price: parseInt(
      [
