...
export const FilterDropdown = memo(({
  ...
  const dropdownStyle = {
    ...
    top: buttonPosition ? `${buttonPosition.bottom + window.scrollY + 8}px` : '0',
    left: isMobile ? '1rem' : buttonPosition ? `${buttonPosition.left}px` : '0',
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/5 backdrop-blur-[1px] z-40" onClick={() => setIsFilterOpen(false)} />
      <div 
        ref={filterRef}
      ...
      >
        ...
        <div className="overflow-y-auto custom-scrollbar divide-y divide-gray-50" style={{ maxHeight: isMobile ? '50vh' : '400px' }}>
